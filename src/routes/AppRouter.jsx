      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<DashboardLayout />}>
            ...
            {/* Default /dashboard route — redirect each role to their home */}
...
function RoleBasedRedirect() {
  ...
  const map = {
    ...
    ROLE_RECEPTION: '/dashboard/donors',
    ROLE_PHLEBOTOMIST: '/dashboard/screenings',
    ROLE_LAB_TECHNICIAN: '/dashboard/lab',
    ROLE_INVENTORY_CONTROLLER: '/dashboard/inventory',
    ROLE_TRANSFUSION_OFFICER: '/dashboard/crossmatch',
    ROLE_DONOR: '/dashboard/my',
  };
  return <Navigate to={map[role] || '/dashboard/admin'} replace />;
}

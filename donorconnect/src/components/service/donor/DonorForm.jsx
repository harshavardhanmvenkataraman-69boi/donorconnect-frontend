          ...
          <div className="card border shadow-sm">
            <div className="card-body">
              ...
              <div className="row g-3">
                ...
                <div className="col-md-4">
                  <DsField label="Pincode" required>
                    <DsInput value={address.pincode}
                      onChange={e => onAddressChange('pincode', e.target.value.replace(/\D/g, '').slice(0, 6))}
                      placeholder="600001"
                      maxLength={6}
                      style={validatePincode(address.pincode) && address.pincode ? { borderColor: '#e53935' } :
                             !address.pincode?.trim() ? { borderColor: '#ffcdd2' } : { borderColor: '#43a047' }} />
                    ...
                    {address.pincode && !validatePincode(address.pincode) && (
                      <div style={{ fontSize:'0.72rem', color:'#43a047', marginTop:4 }}>✓ Valid pincode</div>
                    )}
                  </DsField>
                </div>
              </div>
